...
export const SuggestedQuestions = ({ onQuestionSelect }: SuggestedQuestionsProps) => {
  ...
  const getSuggestedQuestions = () => {
    switch (lessonId) {
      case '5.2':
        return [
          "Как правильно структурировать документацию проекта?",
          "Какие основные разделы должны быть в документации?",
          "Как эффективно презентовать проект заказчику?",
          "Какие типичные ошибки допускаются при создании документации?",
          "Как оценить качество подготовленной документации?"
        ];
      case '5.1':
        return [
          "Как правильно анализировать требования в реальном проекте?",
          "Какие основные документы создаются на этапе анализа требований?",
          "Как эффективно взаимодействовать с заказчиком при сборе требований?",
          "Какие типичные проблемы возникают при работе с требованиями?",
          "Как правильно оформлять документацию по требованиям?"
        ];
      case '4.2':
        return [
      ...
      case '4.1':
        return [
          ...
          "Как правильно составить project schedule и что в него включить?",
          "Какие методы используются для управления бюджетом проекта?",
          "Как эффективно организовать коммуникацию в команде проекта?",
          "Какие основные роли существуют в проектной команде и их обязанности?"
        ];
      case '3.3':
        return [
