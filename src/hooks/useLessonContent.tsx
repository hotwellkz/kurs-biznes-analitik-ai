...
export const useLessonContent = (lessonId: string) => {
  ...
  const getPromptForLesson = (lessonId: string) => {
    switch (lessonId) {
      case '3.1':
        return 'Расскажи подробно как будто ты преподаватель и преподаешь Курс Бизнес Аналитик урок на тему: "SWOT, PESTEL и другие методы анализа Описание методов, Примеры применения"';
      case '1.1':
