...
export const useLessonContent = (lessonId: string) => {
  ...
  const getPromptForLesson = (lessonId: string) => {
    switch (lessonId) {
      case '4.1':
        return 'Расскажи подробно как будто ты преподаватель и преподаеш Курс Бизнес Аналитик урок на тему: "Основы проектного менеджмента Основные понятия (scope, schedule, budget), Взаимодействие с командой проекта"';
      case '3.2':
